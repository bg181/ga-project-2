module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      restaurant.bookings.end_during(start_time, end_time),
      restaurant.bookings.start_during(start_time, end_time),
      restaurant.bookings.happening_during(start_time, end_time),
      restaurant.bookings.enveloping(start_time, end_time),
      restaurant.bookings.identical(start_time, end_time)
    ].flatten
